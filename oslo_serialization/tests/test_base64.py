...
class Base64Tests(test_base.BaseTestCase):
    def test_encode_as_bytes(self):
        ...
        self.assertEqual(b'ZTrDqQ==', base64.encode_as_bytes('e:\xe9'))
        self.assertEqual(
            b'ZTrp', base64.encode_as_bytes('e:\xe9', encoding='latin1')
        )
    ...
    def test_encode_as_text(self):
        ...
        self.assertEqual('ZTrDqQ==', base64.encode_as_text('e:\xe9'))
        self.assertEqual(
            'ZTrp', base64.encode_as_text('e:\xe9', encoding='latin1')
        )
    ...
    def test_decode_as_text(self):
        ...
        self.assertEqual('e:\xe9', base64.decode_as_text('ZTrDqQ=='))
        self.assertEqual(
            'e:\xe9', base64.decode_as_text('ZTrp', encoding='latin1')
        )
